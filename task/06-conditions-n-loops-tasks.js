...
function getDigitalRoot(num) {
    ...
    num = Array.from(n.toString());
    return (num.length === 1) ? n : +num[0] + +num[1];
...
function evaluateTicTacToePosition(position) {
    ...
    return ((a[0] === 'X' && a[0] === a[1] && a[0] === a[2]) ||
            (b[0] === 'X' && b[0] === b[1] && b[0] === b[2]) ||
            (c[0] === 'X' && c[0] === c[1] && c[0] === c[2]) ||
            (a[0] === 'X' && a[0] === b[0] && a[0] === c[0]) ||
            (a[1] === 'X' && a[1] === b[1] && a[1] === c[1]) ||
            (a[2] === 'X' && a[2] === b[2] && a[2] === c[2]) ||
            (a[0] === 'X' && a[0] === b[1] && a[0] === c[2]) ||
            (a[2] === 'X' && a[2] === b[1] && a[2] === c[0])) 
            ? 'X'
            :  ((a[0] === '0' && a[0] === a[1] && a[0] === a[2]) ||
                (b[0] === '0' && b[0] === b[1] && b[0] === b[2]) ||
                (c[0] === '0' && c[0] === c[1] && c[0] === c[2]) ||
                (a[0] === '0' && a[0] === b[0] && a[0] === c[0]) ||
                (a[1] === '0' && a[1] === b[1] && a[1] === c[1]) ||
                (a[2] === '0' && a[2] === b[2] && a[2] === c[2]) ||
                (a[0] === '0' && a[0] === b[1] && a[0] === c[2]) ||
                (a[2] === '0' && a[2] === b[1] && a[2] === c[0]))
                ? '0'
                : undefined;    
}
